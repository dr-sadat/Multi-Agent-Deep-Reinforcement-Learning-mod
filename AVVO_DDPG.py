...
def init(environments_file_name):
    ...
    hyperparameters = {
        ...
        #"discount_rate": 0.996, #default
        "discount_rate": 0.50, #SADAT
        # default step size was 300 for the following 4 parameters 
        "actor_nodes_update_every_n_steps": 100,  # 10 times in one episode
        "critic_nodes_update_every_n_steps": 100,  # 15 times in one episode
        "actor_reward_update_every_n_steps": 100,  # 20 times in one episode
        "critic_reward_update_every_n_steps": 100,  # 20 times in one episode
...
#    run(first=True, given_list_file_name="./Environments/Data/vehicle_1127_1200_bandwidth_3_dataszie_1024_02.pkl")
    run(first=True, environments_file_name="./Environments/Data/vehicle_1127_1200_bandwidth_3_dataszie_1024_02.pkl")  #SADAT
